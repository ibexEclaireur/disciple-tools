...
class Disciple_Tools_Controller {
    ...
    public static function get_tract_map ($address) {
        ...
        if (get_option('_db_option_type') == 'WPDB') {
            ...
            $coordinates = Disciple_Tools_Coordinates_KML::get_tract_kml_coordinates( $geoid, $state ); // return coordinates from KML files
        }
    ...
    public static function get_map_by_geoid ($params) {
        ...
        $zoom = Disciple_Tools_Placemark_Info::get_placemark_zoom($geoid, $state);
