...
class Disciple_Tools_Reports_Post_Type {
     ...
     * @since 0.1
     */
    public function __construct( $post_type = 'reports', $singular = '', $plural = '', $args = array(), $taxonomies = array() ) {
    ...
    /**
     * Register the "reports-category" taxonomy. 
     * @access portal
     * @since  1.3.0
     * @return void
     */
    public function register_taxonomy () {
        $this->taxonomies['reports-type'] = new Disciple_Tools_Taxonomy($post_type = 'reports', $token = 'reports-type', $singular = 'Type', $plural = 'Type', $args = array()); // Leave arguments empty, to use the default arguments.
        $this->taxonomies['reports-type']->register();
...
//        if ( isset( $defaults['taxonomy-reports-type'] ) ) { unset( $defaults['taxonomy-reports-type'] ); }  // Removes the automatic columns generated by taxonomies
    ...
    public function updated_messages ( $messages ) {
        ...
        $messages[$this->post_type] = array(
            ...
            2 => __( 'Report updated.', 'disciple_tools' ),
            3 => __( 'Report deleted.', 'disciple_tools' ),
    ...
    public function meta_box_setup () {
        add_meta_box( $this->post_type . '_details', __( 'Report Details', 'disciple_tools' ), array( $this, 'load_report_info_meta_box' ), $this->post_type, 'normal', 'high' );
    } // End meta_box_setup()
     ...
     * @since  0.1
     */
    public function load_report_info_meta_box () {
    ...
    public function enter_title_here ( $title ) {
        if ( get_post_type() == $this->post_type ) {
            $title = __( 'Enter the report name here', 'disciple_tools' );
        }
        return $title;
