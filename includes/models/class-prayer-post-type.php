 ...
 *
 * All functionality pertaining to prayer post types in Disciple_Tools.
 *
...
class Disciple_Tools_Prayer_Post_Type {
    ...
    public function register_post_type () {
        ...
        $defaults = array(
            ...
            'description'           => __( 'Prayers generated by the media to movement effort', 'disciple_tools' ),
            'labels' 				=> $labels,
            'portal' 				=> true,
	...
	/**
	 * Register the "prayers-category" taxonomy. // TODO: Taxonomies
	 * @access portal
	 * @since  1.3.0
	 * @return void
	 */
	public function register_taxonomy () {
		...
		$this->taxonomies['prayers-source'] = new Disciple_Tools_Taxonomy($post_type = 'prayers', $token = 'prayers-source', $singular = 'Source', $plural = 'Sources', $args = array()); // Leave arguments empty, to use the default arguments.
		$this->taxonomies['prayers-source']->register();
		$this->taxonomies['prayers-type'] = new Disciple_Tools_Taxonomy($post_type = 'prayers', $token = 'prayers-type', $singular = 'Type', $plural = 'Type', $args = array()); // Leave arguments empty, to use the default arguments.
		$this->taxonomies['prayers-type']->register();
    ...
    public function register_custom_column_headings ( $defaults ) {
        ...
        if ( isset( $defaults['taxonomy-prayers-source'] ) ) { unset( $defaults['taxonomy-prayers-source'] ); } // Removes the automatic columns generated by taxonomies
        if ( isset( $defaults['taxonomy-prayers-type'] ) ) { unset( $defaults['taxonomy-prayers-type'] ); }  // Removes the automatic columns generated by taxonomies
    ...
    public function meta_box_setup () {
        add_meta_box( $this->post_type . '_details', __( 'Contact Details', 'disciple_tools' ), array( $this, 'load_prayer_info_meta_box' ), $this->post_type, 'normal', 'high' );
    } // End meta_box_setup()
    ...
    public function enter_title_here ( $title ) {
        if ( get_post_type() == $this->post_type ) {
            $title = __( 'Enter the prayer name here', 'disciple_tools' );
        }
        return $title;
