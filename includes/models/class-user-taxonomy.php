...
class Disciple_Tools_User_Taxonomy {
			...
			<thead>
				<tr>
					<td id="cb" class="manage-column column-cb check-column">
						<label class="screen-reader-text" for="cb-select-all-1"><?php esc_html_e( 'Select All', 'disciple-tools-user-groups' ); ?></label>
						<input id="cb-select-all-1" type="checkbox">
					</td>
					<th scope="col" class="manage-column column-name column-primary"><?php esc_html_e( 'Name', 'disciple-tools-user-groups' ); ?></th>
					<th scope="col" class="manage-column column-description"><?php esc_html_e( 'Description', 'disciple-tools-user-groups' ); ?></th>
					<th scope="col" class="manage-column column-users"><?php esc_html_e( 'Users', 'disciple-tools-user-groups' ); ?></th>
				</tr>
			</thead>
			<tbody>
			...
			<tfoot>
				<tr>
					<td class="manage-column column-cb check-column">
						<label class="screen-reader-text" for="cb-select-all-2"><?php esc_html_e( 'Select All', 'disciple-tools-user-groups' ); ?></label>
	...
	public function bulk_notice() {
		...
		?><div id="message" class="updated notice notice-success is-dismissible"><p><?php
			echo esc_html( $text );
			?><button type="button" class="notice-dismiss"><span class="screen-reader-text"><?php esc_html_e( 'Dismiss this notice.', 'disciple-tools-user-groups' ); ?></span></button>
		</p></div><?php
	}
			...
			<div id="<?php echo esc_attr( $this->taxonomy ); ?>-header">
				<h1>
					...
					<?php if ( current_user_can( 'create_users' ) ) : ?>
						...
						<a href="<?php echo esc_url( admin_url( 'user-new.php' ) ); ?>" class="page-title-action"><?php echo esc_html_x( 'Add New', 'user', 'disciple-tools-user-groups' ); ?></a>

					<?php elseif ( is_multisite() && current_user_can( 'promote_users' ) ) : ?>

						<a href="<?php echo esc_url( admin_url( 'user-new.php' ) ); ?>" class="page-title-action"><?php echo esc_html_x( 'Add Existing', 'user', 'disciple-tools-user-groups' ); ?></a>

					<?php endif; ?>

					<span class="subtitle"><?php printf( esc_html__( 'Viewing users of %s: %s', 'disciple-tools-user-groups' ), $this->tax_singular_low, '<a href="' . esc_url( $url ) . '">' . $terms[ $viewing ]->name . '</a>' ); ?></span>
				</h1>
