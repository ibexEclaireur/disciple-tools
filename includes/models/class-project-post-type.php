...
/**
 * Disciple_Tools Plugin Project Updates Post Type Class
 *
 * All functionality pertaining to project update post types in Disciple_Tools.
 *
 ...
 * @since 0.1
 */
class Disciple_Tools_Project_Post_Type {
    /**
     * The post type token.
     * @access public
     * @since  0.1
     ...
     * @since 0.1
     */
    public function __construct( $post_type = 'project', $singular = '', $plural = '', $args = array(), $taxonomies = array() ) {
    ...
    public function register_post_type () {
        $labels = array(
            'name' 					=> sprintf( _x( '%s', 'Project Update', 'disciple_tools' ), $this->plural ),
    ...
    /**
     * Register the "projects-category" taxonomy.
     * @access public
     * @since  1.3.0
     * @return void
     */
    public function register_taxonomy () {
        $this->taxonomies['project-type'] = new Disciple_Tools_Taxonomy($post_type = 'project', $token = 'project-type', $singular = 'Type', $plural = 'Types', $args = array()); // Leave arguments empty, to use the default arguments.
        $this->taxonomies['project-type']->register();
...
//        add_meta_box( $this->post_type . '_details', __( 'Audience', 'disciple_tools' ), array( $this, 'load_project_info_meta_box' ), $this->post_type, 'normal', 'high' );
    } // End meta_box_setup()
     ...
     * @since  0.1
     */
    public function load_project_info_meta_box () {
    ...
    public function get_custom_fields_settings () {
        ...
        $fields['audience'] = array(
            ...
            'description' => 'Prayer Supporters are level 1; Project Supporters are level 2. Project supporters see all project supporter posts, but project supporters do not see project supporter posts.',
            'type' => 'select',
