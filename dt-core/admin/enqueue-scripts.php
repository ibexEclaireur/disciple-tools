...
function contact_page_scripts() {
    ...
    if ( ('post.php' === $pagenow || 'post-new.php' === $pagenow) && 'contacts' === get_post_type( $post )) {
        ...
        wp_register_style( 'dt_admin_css', Disciple_Tools()->plugin_css_url . 'disciple-tools-admin-styles.css' );
        wp_enqueue_style( 'dt_admin_css' );

        wp_enqueue_script( 'dt_contact_scripts', Disciple_Tools()->plugin_js_url .'dt-contacts.js', ['jquery', 'jquery-ui-core'], '1.0.0', true );
        wp_enqueue_script( 'dt_shared_scripts', Disciple_Tools()->plugin_js_url .'dt-shared.js', [], '1.0.0', true );
    }
}
...
function group_page_scripts() {
    ...
    if ( ('post.php' === $pagenow || 'post-new.php' === $pagenow ) && 'groups' === get_post_type( $post ) ) {
        ...
        wp_enqueue_script( 'dt_group_scripts', Disciple_Tools()->plugin_js_url .'dt-groups.js', [ 'jquery', 'jquery-ui-core' ], '1.0.0', true );
        wp_enqueue_script( 'dt_shared_scripts', Disciple_Tools()->plugin_js_url .'dt-shared.js', [], '1.0.0', true );
...
function location_page_scripts() {
    ...
    if ( ('post.php' === $pagenow || 'post-new.php' === $pagenow) && 'locations' === get_post_type( $post ) ) {
        ...
        wp_enqueue_script( 'dt_group_scripts', Disciple_Tools()->plugin_js_url .'dt-locations.js', ['jquery', 'jquery-ui-core'], '1.0.0', true );
        wp_enqueue_script( 'dt_shared_scripts', Disciple_Tools()->plugin_js_url .'dt-shared.js', [], '1.0.0', true );
    }
}
...
function asset_page_scripts() {
    ...
    if ( ('post.php' === $pagenow || 'post-new.php' === $pagenow) && 'assets' === get_post_type( $post ) ) {
        ...
        wp_enqueue_script( 'dt_group_scripts', Disciple_Tools()->plugin_js_url .'dt-assets.js', ['jquery', 'jquery-ui-core'], '1.0.0', true );
        wp_enqueue_script( 'dt_shared_scripts', Disciple_Tools()->plugin_js_url .'dt-shared.js', [], '1.0.0', true );
    }
}
...
function dismiss_notice_callback_script(){
    ...
    if (is_admin() && $pagenow === 'options-general.php'){
        wp_enqueue_script( 'disciple-tools-admin_script', Disciple_Tools()->plugin_js_url .'disciple-tools-admin.js',  ['jquery'], '1.0', true );
    }
}
