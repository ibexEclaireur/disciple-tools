...
class Disciple_Tools_GitHub_Plugin_Updater
{
    ...
    {
        add_filter( "pre_set_site_transient_update_plugins", [ $this, "set_transitent" ] );
        add_filter( "plugins_api", [ $this, "set_plugin_info" ], 10, 3 );
        add_filter( "upgrader_pre_install", [ $this, "pre_install" ], 10, 3 );
    ...
    public function set_plugin_info( $false, $action, $response )
    {
        ...
        // Load Parsedown
        require_once plugin_dir_path( __DIR__ ) . 'libraries/Parsedown.php';
