...
// Define the function
    ...
    <p class="description"><?php _e( 'You can specify the email address that emails should be sent from. If you leave this blank, the default email will be used.', 'wp_mail_smtp' );
    if(get_option( 'db_version' ) < 6124) { print('<br /><span style="color: red;">');
